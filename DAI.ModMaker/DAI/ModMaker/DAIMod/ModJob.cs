                ...
                switch (childNode.Name)
                {
                    case "details":
                        foreach (XmlNode xmlNodes in childNode.ChildNodes)
                        {
                            ...
                            {
                                case "name":
                                    Meta.Details.Name = xmlNodes.InnerText;
                                    break;
                                case "version":
                                    Meta.Details.Version = xmlNodes.InnerText;
                                    break;
                                case "author":
                                    Meta.Details.Author = xmlNodes.InnerText;
                                    break;
                                case "description":
                                    Meta.Details.Description = xmlNodes.InnerText;
                                    break;
                            }
                        }
                        break;
                    case "resources":
                        ...
                        {
                            if (!(childNode2.Name != "resource"))
                            {
                                ModResourceEntry modResourceEntry = null;
                                switch (childNode2.Attributes["type"].Value)
                                {
                                    case "chunk":
                                        modResourceEntry = new ChunkModResourceEntry(childNode2.Attributes);
                                        break;
                                    case "res":
                                        modResourceEntry = new ResModResourceEntry(childNode2.Attributes);
                                        break;
                                    case "ebx":
                                        modResourceEntry = new EbxModResourceEntry(childNode2.Attributes);
                                        break;
                                }
